...
export function getProgressPct(totalPts: number): number {
...
// Alias — sama dengan getProgressPct, untuk kompatibilitas
export const getProgressToNext = getProgressPct;

// Poin yang dibutuhkan untuk naik level berikutnya
