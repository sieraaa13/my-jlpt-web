        ...
        <div className="relative bg-gray-900 rounded-2xl p-6 max-w-5xl w-full">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-400">
              Ambil foto → AI akan anime-kan → masuk ke template!
            </p>
          </div>
...
<div id="template-photobooth">
    ...
    <div class="ai-loading-overlay" id="ai-loading-overlay" style="display:none;">
        <div class="ai-loading-box">
            ...
            <p class="ai-loading-text" id="ai-loading-text">✨ AI sedang mengubah foto kamu jadi anime...</p>
...
class TemplatePhotobooth {
  ...
  async capturePhoto() {
    ...
    ctx.restore();
    const photoBase64 = captureCanvas.toDataURL('image/jpeg', 0.85);
    ...
    try {
      ...
      const res = await fetch('/api/photobooth/generate', {
        ...
        body: JSON.stringify({ image: photoBase64, template: 'underwater' }),
      });
      ...
      // 4. Pakai URL hasil AI sebagai foto
  ...
  download() {
    ...
    // Tunggu semua gambar selesai di-draw
    setTimeout(() => {
      const link = document.createElement('a');
      link.download = 'underwater-anime-photobooth-' + Date.now() + '.png';
