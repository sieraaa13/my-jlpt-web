...
export const n2KanjiLessons: Record<string, Record<string, KanjiSignLessonDay>> = {
  ...
  "6": {
    ...
    "3": w6d3 as KanjiSignLessonDay,
    "4": w6d4 as KanjiSignLessonDay,
    "5": w6d5 as KanjiSignLessonDay,
    "6": w6d6 as KanjiSignLessonDay,
  },
  "7": {
    "1": w7d1 as KanjiSignLessonDay,
    "2": w7d2 as KanjiSignLessonDay,
    "3": w7d3 as KanjiSignLessonDay,
    "4": w7d4 as KanjiSignLessonDay,
    "5": w7d5 as KanjiSignLessonDay,
    "6": w7d6 as KanjiSignLessonDay,
  },
  "8": {
    "1": w8d1 as KanjiSignLessonDay,
    "2": w8d2 as KanjiSignLessonDay,
    "3": w8d3 as KanjiSignLessonDay,
    "4": w8d4 as KanjiSignLessonDay,
    "5": w8d5 as KanjiSignLessonDay,
    "6": w8d6 as KanjiSignLessonDay,
  },
};
...
export const n2KanjiTests: Record<string, Record<string, N2KanjiTestDay>> = {
  ...
  "5": {
    "7": w5d7 as unknown as N2KanjiTestDay,
  },
  "6": {
    "7": w6d7 as unknown as N2KanjiTestDay,
  },
  "7": {
    "7": w7d7 as unknown as N2KanjiTestDay,
  },
  "8": {
    "7": w8d7 as unknown as N2KanjiTestDay,
  },
};
