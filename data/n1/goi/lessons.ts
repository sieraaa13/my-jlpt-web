...
export const goiLessons: Record<string, Record<string, GoiLessonDay>> = {
  ...
  "7": {
    "1": w7d1 as GoiLessonDay,
    "2": w7d2 as GoiLessonDay,
    "3": w7d3 as GoiLessonDay,
    "4": w7d4 as GoiLessonDay,
    "5": w7d5 as GoiLessonDay,
    "6": w7d6 as GoiLessonDay,
  },
  "8": {
    "1": w8d1 as GoiLessonDay,
    "2": w8d2 as GoiLessonDay,
    "3": w8d3 as GoiLessonDay,
    "4": w8d4 as GoiLessonDay,
    "5": w8d5 as GoiLessonDay,
    "6": w8d6 as GoiLessonDay,
  },
};
...
export const goiTests: Record<string, Record<string, GoiTestDay>> = {
  ...
  "7": {
    "7": w7d7 as GoiTestDay,
  },
  "8": {
    "7": w8d7 as GoiTestDay,
  },
};
