...
const materials = [
  ...
  },
  {
    ...
    title: "Latihan Soal",
    japanese: "練習問題",
    description: "Kerjakan soal-soal JLPT N1 dari tahun 2011-2025",
    icon: "✍️",
    link: "/jlpt/n1?type=exam",
    color: "from-orange-500/20 to-amber-500/20",
    borderColor: "border-orange-400/50",
  },
];

function N1PageContent() {
        ...
        <div className="pt-16">
          <div className="bg-card border-b border-border py-6 mb-8">
            <div className="max-w-6xl mx-auto px-4">
              ...
              <h1 className="text-3xl font-bold">JLPT N1 - Latihan Soal</h1>
              <p className="text-muted-foreground text-sm mt-1">Profesional - Level Tertinggi JLPT</p>
            </div>
          </div>
          <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mt-4 mb-6">
              ...
              <span className="text-primary">N1</span>
            </h1>
            <p className="text-2xl text-accent mb-3">レベル1</p>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              Kuasai bahasa Jepang profesional - Level tertinggi JLPT. Pilih materi belajar di bawah ini.
            </p>
          </div>
