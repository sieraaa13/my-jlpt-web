...
import {
  ...
  getAllLessonParams,
  getAdjacentLessons,
} from "@/data/n2/soumatome/lessons";
import { WeekChecklistN2 } from "@/components/week-checklist-n2";
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          {data.illustration_text && (
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              {Object.entries(data.illustration_text).map(([key, text], idx) =>
                text ? (
                  <div
                    key={key}
                    className={`flex-1 bg-secondary/40 border border-border rounded-2xl p-4 ${
                      idx === 0 ? "rounded-bl-none" : "rounded-br-none"
                    }`}
                  >
          ...
          {data.exercise_groups && data.exercise_groups.length > 0 && (
            <>
              <div className="mt-12">
                <WeekChecklistN2 week={Number(week)} />
              </div>
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center">
            {prev ? (
              <Link
                href={`/jlpt/n2/soumatome/${prev.week}/${prev.day}`}
            ...
            {next ? (
              <Link
                href={`/jlpt/n2/soumatome/${next.week}/${next.day}`}
