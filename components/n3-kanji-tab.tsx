...
import { getOrganizedN3KanjiLessons, n3KanjiLessons, n3KanjiTests } from "@/data/n3/kanji/lessons";

export function N3KanjiTab() {
  const weeks = getOrganizedN3KanjiLessons();
  ...
  const lesson = n3KanjiLessons[selectedWeek]?.[selectedDay];
  const test = n3KanjiTests[selectedWeek]?.[selectedDay];
