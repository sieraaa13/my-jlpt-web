...
function PassageSection({ test }: { test: KanjiTestDay }) {
...
export function KanjiTestView({ test }: { test: KanjiTestDay }) {
  return (
    <div className="space-y-8">
      ...
      <Card className="p-6 bg-card">
        <h3 className="text-lg font-bold mb-4">問題1 — Pilih cara baca yang tepat</h3>
      ...
      <Card className="p-6 bg-card">
        <h3 className="text-lg font-bold mb-4">問題2 — Pilih penulisan kanji yang tepat</h3>
        <div className="space-y-5">
          {test.kanjiChoiceQuestions.map((q, i) => (
            <MultipleChoiceItem
              key={i}
              index={i + 1}
      ...
      <Card className="p-6 bg-card">
        <h3 className="text-lg font-bold mb-4">問題3 — Lengkapi kanji yang kosong</h3>
        <div className="space-y-5">
